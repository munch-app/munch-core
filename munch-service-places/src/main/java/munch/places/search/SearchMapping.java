...
public class SearchMapping {
    ...
    public static final String GEO_PRECISION = "10.0m";
    ...
    @Inject
    public SearchMapping(RestClient client, ObjectMapper mapper) {
        this.client = client;
        this.mapper = mapper;
    ...
    private class Validator {
        ...
        private boolean isGeo(JsonNode rootNode) {
            ...
            return geoProps.path("type").asText().equalsIgnoreCase("geo_shape") &&
                    geoProps.path("tree").asText().equalsIgnoreCase("quadtree") &&
                    geoProps.path("precision").asText().equalsIgnoreCase(GEO_PRECISION);
        }
    }
}
