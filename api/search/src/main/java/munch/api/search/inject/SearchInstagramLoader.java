...
import munch.api.search.cards.SearchPartnerInstagramCard;
...
public final class SearchInstagramLoader implements SearchCardInjector.Loader {
    ...
    public List<Position> load(Request request) {
        ...
        instagramCard.setContents(placeClient.batchGet(card.getMediaList(), InstagramMedia::getPlaceId,
                (m, p) -> new SearchPartnerInstagramCard.MediaContent(p, m))
        );
